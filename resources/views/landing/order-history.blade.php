            ...
            @forelse ($orders as $order)
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="mt-4 flex justify-end gap-x-4">
                        ...
                        @endif
                        @if ($order->status == 'Pesanan diterima' && $order->ulasan == null)
                            <a href="{{ route('ulasan.edit', $order->id) }}"
                                class="block text-white bg-yellow-400
                            hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg
                            text-sm px-5 py-2.5 text-center d">Beri
                                Ulasan</a>
                        @endif
                        ...
                        @if ($order->status == 'Pesanan diterima' && $order->ulasan != null)
                            <a href="{{ route('detail.ulasan', $order->id) }}"
                                class="block text-white bg-green-700
                            hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg
                            text-sm px-5 py-2.5 text-center d">Detail
                                Ulasan</a>
                        @endif
                    </div>
                </div>
