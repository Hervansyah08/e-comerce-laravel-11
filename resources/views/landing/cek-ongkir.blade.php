...
@section('content')
    ...
    <div class="container mx-auto px-4  mt-4">
        ...
        <form action="{{ route('cek-ongkir') }}" class="w-1/3 mx-auto" method="POST">
            @csrf
            <h1 class="text-xl text-bold mb-3  text-gray-900">Cek Ongkir</h1>
        ...
        @if ($ongkir != '')
            <h2 class="text-lg text-center  font-bold my-2">Rincian Ongkir</h2>
            <h5 class="mb-4 text-xl text-center font-bold tracking-tight text-gray-900 dark:text-white">
                {{ $ongkir['name'] }}
            </h5>
