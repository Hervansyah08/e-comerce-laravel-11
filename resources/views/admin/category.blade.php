...
@section('content')
    ...
    <div class="relative overflow-x-auto">
        {{-- serach --}}
        <form class="max-w-md py-6" action="{{ route('admin.categories.index') }}" method="GET">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    ...
                    placeholder="Search Nama dan Deskripsi" name="search" value="{{ request('search') }}" />
                <button type="submit"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button"
                        ...
                        data-modal-hide="deleteModal-{{ $category->id }}">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah Anda Yakin Mengahpus
