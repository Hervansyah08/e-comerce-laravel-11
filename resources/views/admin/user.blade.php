...
@section('content')
    ...
    <div class="flex flex-wrap justify-between align-items-center">
        <h2 class="text-4xl font-bold  dark:text-white">Daftar Role User</h2>
        {{-- <button type="button"
    ...
    <div class="relative overflow-x-auto">
        {{-- serach --}}
        <form class="max-w-md py-6" action="{{ route('admin.user.index') }}" method="GET">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    ...
                    placeholder="Search Nama dan Email" name="search" value="{{ request('search') }}" />
                <button type="submit"
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <div class="inline-flex rounded-md shadow-sm" role="group">
                                ...
                                {{-- <button type="button" data-modal-target="updateModal-{{ $user->id }}"
                                    data-modal-toggle="updateModal-{{ $user->id }}"
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}"
                                class="@error('email') border-red-500 @enderror bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="">
                            @error('email')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="address" id="address" value="{{ old('address') }}"
                                class="@error('address') border-red-500 @enderror bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="">
                            @error('address')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="password" name="password" id="password" value="{{ old('password') }}"
                                class="@error('password') border-red-500 @enderror bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="">
                            @error('password')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation"
                                class="bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                placeholder="">
                        </div>
